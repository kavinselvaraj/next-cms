...
export const prismicConfig = {
    ...
    get migrationStrategy() {
        return (
            getSharedEnvValue("PRISMIC_MIGRATION_STRATEGY") ?? getSharedEnvValue("MIGRATION_STRATEGY")
        );
    },
    get migrationValue() {
        return getSharedEnvValue("PRISMIC_MIGRATION_VALUE") ?? getSharedEnvValue("MIGRATION_VALUE");
    },
    routes: [],
} as const;
